...
public class CheckCode {
    ...
    private static final String APP_KEY = "9e4d79fbb83bf33d639505643863c040";//网易云分配的账号
    private static final String APP_SECRET = "dba87dfc0713";//密码
    // private static final String MOULD_ID="14841380";//模板ID
    private static final String NONCE = "14846449";//随机数
    //验证码长度，范围4～10，默认为4
